        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">เพิ่มข้อมูลรอบรถ</h5>
                            <!-- Form -->
                            <?php
                            $sub = '';
                            if (!empty($_POST)) {
                            ...
                            <form class="needs-validation" novalidate method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" aria-label="Default select example" name="route_id" required>
                                            ...
                                            ?>
                                                <option value="<?= $row['route_id'] ?>"><?= $row['source'] ?> - <?= $row['destination'] ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" name="departure_date" class="form-control" id="yourName" required>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="time" name="departure_time" class="form-control" id="yourName" required>
