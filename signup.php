            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.php" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Bus Ticket</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">สมัครบัญชี</h5>
                    <p class="text-center small">ป้อนข้อมูลให้ครบเพื่อสร้างบัญชี</p>
                  </div>
                    <!-- php signup -->
                    <?php 
                        $sub = '';
                  ...
                  <form class="row g-3 needs-validation" novalidate method="post">
                    ...
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">นามสกุล</label>
                      <input type="text" name="last_name" class="form-control" id="yourName" required>
                      <div class="invalid-feedback">กรุณาป้อนนามสกุล</div>
                    </div>

                    <div class="col-12">
                      <label for="yourEmail" class="form-label">เบอร์โทรศัพท์</label>
                      <input type="number" name="phone_number" class="form-control" id="yourName" required>
                      <div class="invalid-feedback">กรุณาป้อนเบอร์โทรศัพท์</div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">มีบัญชีแล้ว ? <a href="login.php">เข้าสู่ระบบ</a></p>
                    </div>
                  </form>
