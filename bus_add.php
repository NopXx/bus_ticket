                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (!empty($_POST)) {
                                ...
                                if ($data['num'] == 0) {
                                    $sql_insert = 'INSERT INTO bus (bus_name, bus_type, total_seats) VALUES ("' . $_POST['bus_name'] . '", "' . $_POST['bus_type'] . '", ' . $_POST['total_seats'] . ')';
                                    // echo $sql_insert;
                            ...
                            <form class="needs-validation" novalidate method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="bus_name" class="form-control" id="yourName" required>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" aria-label="Default select example" name="bus_type" required>
                                            ...
                                            <option value="รถปรับอากาศชั้น 1">รถปรับอากาศชั้น 1</option>
                                            <option value="รถปรับอากาศชั้น 2">รถปรับอากาศชั้น 2</option>
                                        </select>
