        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              ...
              $sub = '';
              if (!empty($_POST)) {
                $sql_insert = 'INSERT INTO route (source, destination) VALUES ("' . $_POST['source'] . '", "' . $_POST['destination'] . '")';
                // echo $sql_insert;
              ...
              <form class="needs-validation" novalidate method="post">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="source" class="form-control" id="yourName" required>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="destination" class="form-control" id="yourName" required>
